...
class AddWorkFlowFunctionSubscriberTest extends AbstractBaseTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->authorization = Phake::mock('OpenOrchestra\WorkflowFunction\Model\AuthorizationInterface');
        $this->workflowRight = Phake::mock('OpenOrchestra\WorkflowFunction\Model\WorkflowRightInterface');
        $this->workflowRightEvent = Phake::mock('OpenOrchestra\WorkflowFunction\Event\WorkflowRightEvent');
