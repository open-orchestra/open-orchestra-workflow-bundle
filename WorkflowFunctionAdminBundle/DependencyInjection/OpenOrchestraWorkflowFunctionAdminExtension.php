...
class OpenOrchestraWorkflowFunctionAdminExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        foreach ($config['transformer'] as $transformerName => $transformer ) {
            $container->setParameter('open_orchestra_workflow_function_admin.facade.' . $transformerName .'.class', $transformer['facade']);
        }
        ...
        $container->setParameter('open_orchestra_backoffice.collector.role.workflow_role_in_group', false);
    }
}
